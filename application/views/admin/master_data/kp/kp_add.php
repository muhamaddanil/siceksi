<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <a href="<?php echo site_url('kp/add')?>" class="btn btn-success btn-icon-split btn-sm">
        <span class="icon text-white-50">
    ...
    <div class="card-body">
      ...
      <?php echo form_open_multipart("kp/input")?>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="kp_judul" required="required">
      </div>

      <div class="form-group">
        <label for=""><b>KP Tahun</b></label>
        <input type="number" class="form-control" name="kp_tahun" required="required">
      </div>
      
      <div class="form-group">
        <label for=""><b>KP Tempat</b></label>
        <input type="text" class="form-control" name="kp_tempat" required="required">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="file" class="form-control" name="pengesahan_pembimbing" required="required" accept="application/pdf">
      </div>

      <div class="form-group">
        <label for=""><b>Upload Proposal KP</b></label>
        <input type="file" class="form-control" name="kp_full" required="required" accept="application/pdf">
      </div>
      
      <hr>
      <button style="width: 100%" class="btn btn-success" type="submit">Tambah kp</button>
      <?php echo form_close(); ?>
    </div>
  </div>
